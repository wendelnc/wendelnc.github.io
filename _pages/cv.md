...
* Doctor of Philosophy, Michigan State University
	* Computational Mathematics Science and Engineering and Physics & Astronomy (dual Ph.D.) 
	* August 2021 - present
	* GPA - 3.95
	* Advisor - Andrew Christlieb
	* Thesis - High Order Numerical Methods for Magnetohydrodynamic Turbulence
...
======
* Optical Engineer II, North American Lighting
  * August 2018 – August 2021
  * Provided engineering, design, and development support for optical systems in exterior automotive lighting products
  * Designed, simulated, and analyzed automotive lighting systems using CATIA-V5, LucidShape, and SPEOS
  * Created, edited, and modified macros in VBA for CATIA, Excel, and PowerPoint
...
* Graduate Research Assistant, Michigan State University 
  * August 2021 – present
  * Developed SPARTHA, an arbitrarily high-order weighted essentially non-oscillatory code for ideal MHD, built on PARTHENON and KOKKOS
  * Quantified the impact of high-order methods on the numerical viscosity and resistivity in ideal MHD turbulence simulations using energy transfer analysis
  * Increased the accuracy and reliability of numerical simulations of complex turbulent plasma systems
...
* Graduate Research Assistant, University of Michigan 
  ...
  * Analyzed the adverse effects and potential contamination of scattered light on plasma diagnostics for the EUV Imaging Spectrometer (EIS) instrument onboard Hinode
  * Reduced and analyzed data from the EIS instrument using IDL

* Research Scientist, Solar Wind Sherpas
	* August 2017
	* Observed and collected narrow-band and spectrally resolved observations of the solar corona during the 2017 total solar eclipse
  * Led the magnetometer experiment aimed to measure magnetic fluctuations due to changes in the ionospheric current during the eclipse

* Intern, Center for Astrophysics – Harvard & Smithsonian
	* May 2015 – August 2015
	* Interpreted the complex relationship between the transition region and upper coronal layers of the solar atmosphere
  * Wrote and ran code in IDL to analyze data from the Atmospheric Imaging Assembly (AIA) onboard the Solar Dynamic Observatory (SDO) and the Interface Region Imaging Spectrograph (IRIS) satellites 
...
* Graduate Teaching Assistant, Michigan State University 
  * CMSE 201 (Introduction to Computational Modeling)
    ...
    * Guided students through flipped-classroom activities involving algorithmic thinking, dataset manipulation, model building, data visualization, and numerical method implementation
    * Graded bi-weekly homework assignments and tutored students through office hours

* ACRES Mentoring Chair, Michigan State University
	* May 2023 – August 2023
  * Created and delivered weekly professional workshops and social events for the Advanced Computational Research Experience (ACRES) students


* Lawrence Technological University, Adjunct Professor
  * PHY 2213 (College Physics 1)
    * 4 consecutive semesters, 20 students per semester
    * Taught evening courses while concurrently fulfilling full-time duties as an Optical Engineer II
    * Wrote and prepared lectures for undergraduate students, evaluated course material, constructed and graded individual homework assignments and exams
    * Student Course Evaluations rated 4.6/5 for overall effectiveness of the course and performance as the instructor
    * Rated 4.7/5 on Rate My Professors

* Graduate Student Instructor, University of Michigan
	* May 2017 – August 2017
  * ASTRO 101 (Introductory Astronomy)
...
* Undergraduate Learning Assistant, Michigan State University
  ...
  * PHY 183 (Physics for Scientists and Engineers) 
    ...
    * Provided student support through office hours, homework assistance, and exam proctoring

  * AST 207 (The Science of Astronomy) 
    * Fall 2014; 130 students per semester
    * Graded weekly homework assignments and exams, held office hours to tutor students on course material 
...
* Data Science Student Conference Outstanding Poster Award, Fall 2025

* Member of Tau Beta Pi, Spring 2024 – present 
...
* Lyman Briggs Undergraduate Research Assistant Award, Fall 2013 & Fall 2014

* Dean’s Honor List, Lyman Briggs College, Fall 2012 – Fall 2014, Spring 2016

* Member of National Society of Collegiate Scholars, Fall 2012 – Spring 2016	


Skills
======
* Programming Languages
	* Python (NumPy, SciPy, SymPy, Pandas, Matplotlib YT, h5py, Astropy)
	* C++ (OpenMP, MPI, CUDA, KOKKOS) 
	* MATLAB
	* VBA
	* IDL
	* LaTeX	 
